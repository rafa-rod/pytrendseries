...
def plot_drawdowns(precos: pd.DataFrame, figsize = (10,4), color="gray", alpha=0.6, axis="y", **kwargs):
    ...
    plt.fill_between(df0["maxdd"].index, -df0["maxdd"].values*100, color=kwargs.get('color'), alpha=kwargs.get('alpha'))
...
def plot_evolution(precos: pd.DataFrame, figsize = (10,4), colors=["gray", "red"], alphas=[1,0.6], axis="y", **kwargs):
